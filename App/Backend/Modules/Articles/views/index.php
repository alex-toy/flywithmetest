<h2 style="text-align:left">Il y a actuellement <?= $nombreNews ?> articles. En voici la liste :</h2>
...
foreach ($listeArticles as $art)
{
  ...
  '<tr>
 		...
 		<td style="text-align:center"><a href="/~alexei/FlyWithMeOC2/Web/admin/articles-list-unvalidated-comment-', $art['id'], '.html"><img src="/~alexei/FlyWithMeOC2/Web/images/listcomment.png" width="50" alt="Supprimer" /></a></td>
